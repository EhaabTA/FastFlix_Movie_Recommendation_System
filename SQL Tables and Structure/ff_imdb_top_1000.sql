CREATE DATABASE  IF NOT EXISTS `ff` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `ff`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: ff
-- ------------------------------------------------------
...
CREATE TABLE `imdb_top_1000` (
  ...
  `Overview` varchar(313) DEFAULT NULL,
  `Meta_score` varchar(3) DEFAULT NULL,
  `Director` varchar(32) DEFAULT NULL,
  `Star1` varchar(25) DEFAULT NULL,
  `Star2` varchar(25) DEFAULT NULL,
  `Star3` varchar(27) DEFAULT NULL,
  `Star4` varchar(27) DEFAULT NULL,
  `No_of_Votes` int(7) DEFAULT NULL,
...
-- Dump completed on 2024-04-15 21:46:34
